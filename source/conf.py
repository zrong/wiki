...
# -*- coding: utf-8 -*-
#
# zrong's wiki documentation build configuration file, created by
# sphinx-quickstart on Sun Oct  8 23:03:56 2017.
#
...
project = 'zrong\'s wiki'
copyright = '2005-2022, zrong'
author = 'zrong'
...
htmlhelp_basename = 'zrongswikidoc'
...
latex_documents = [
    (master_doc, 'zrongswiki.tex', 'zrong\'s wiki Documentation',
     'zrong', 'manual'),
]
...
man_pages = [
    (master_doc, 'zrongswiki', 'zrong\'s wiki Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zrongswiki', 'zrong\'s wiki Documentation',
     author, 'zrongswiki', 'One line description of project.',
     'Miscellaneous'),
]
